...
const products = [
  {
    ...
    images: ['https://example.com/products/airmax-1.jpg'], category: 'Sports',
  ...
  },
  {
    ...
    images: ['https://example.com/products/headphones-1.jpg'], category: 'Electronics',
  ...
  },
  {
    ...
    images: ['https://example.com/products/smartwatch-1.jpg'], category: 'Electronics',
  ...
  },
  {
    ...
    images: ['https://example.com/products/speaker-1.jpg'], category: 'Electronics',
  ...
  },
  {
    ...
    images: ['https://example.com/products/watch-1.jpg'], category: 'Fashion',
  ...
  },
  {
    ...
    images: ['https://example.com/products/bag-1.jpg'], category: 'Fashion',
  ...
  },
  {
    ...
    images: ['https://example.com/products/jacket-1.jpg'], category: 'Fashion',
  ...
  },
  {
    ...
    images: ['https://example.com/products/pot-1.jpg'], category: 'Home',
  ...
  },
  {
    ...
    images: ['https://example.com/products/diffuser-1.jpg'], category: 'Home',
  ...
  },
  {
    ...
    images: ['https://example.com/products/serum-1.jpg'], category: 'Beauty',
    variants: { colors: [] },
  ...
  },
  {
    ...
    images: ['https://example.com/products/lipstick-1.jpg'], category: 'Beauty',
  ...
  },
  {
    ...
    images: ['https://example.com/products/book-1.jpg'], category: 'Books',
    variants: { colors: [] },
  ...
  },
  {
    ...
    images: ['https://example.com/products/tea-1.jpg'], category: 'Food',
    variants: { colors: [] },
  ...
  },
  {
    ...
    images: ['https://example.com/products/blocks-1.jpg'], category: 'Toys',
    variants: { colors: [] },
